...
show_menu() {
    ...
    print ""
    print "  ${BOLD}[1]${NC} $(_ menu_install) - $(_ menu_install_desc)"
    print "  ${BOLD}[2]${NC} $(_ menu_import) - $(_ menu_import_desc)"
    print "  ${BOLD}[3]${NC} $(_ menu_select) - $(_ menu_select_desc)"
    print "  ${BOLD}[4]${NC} $(_ menu_start) - $(_ menu_start_desc)"
    print "  ${BOLD}[5]${NC} $(_ menu_stop) - $(_ menu_stop_desc)"
    print "  ${BOLD}[6]${NC} $(_ menu_panel) - $(_ menu_panel_desc)"
